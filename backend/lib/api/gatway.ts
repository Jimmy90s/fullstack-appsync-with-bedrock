...
export const createAmplifyGraphQLAPI = (
  ...
  // const generateStockExplanationResolver = api.addResolver("bedrockResolver", {
  //   dataSource: bedrockDataSource,
  //   typeName: "Query",
  //   fieldName: "generateStockExplanation",
  //   code: Code.fromAsset(path.join(__dirname, "generateStockExplanation.js")),
